...
const App: React.FC = () => {
  ...
  const handleRunAnalysis = useCallback(async () => {
    ...
    try {
      ...
      // ✅ FIXED: Use comprehensive prompt that asks for all types of analysis
      const comprehensivePrompt = `
      Please analyze this Bengali document comprehensively:

      "${documentText}"

      Provide a complete analysis including:
      1. Spelling and grammar corrections
      2. Missing document elements (like Subject, Date, Signature, etc.)
      3. Formatting suggestions (spacing, alignment, etc.)
      4. General feedback on the document
